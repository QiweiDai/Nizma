 ...
 */
public class HzTeacherAdapter extends BaseAdapter {
    LayoutInflater inflater;
    Context context;
    ArrayList<HzTeacher> list;

    public HzTeacherAdapter(Context context, ArrayList<HzTeacher> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        HzTeacher hcc = (HzTeacher)list.get(position);
        viewHolder.textView.setText(hcc.getName());
        return convertView;
    }
