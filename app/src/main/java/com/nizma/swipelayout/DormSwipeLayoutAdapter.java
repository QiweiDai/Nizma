 ...
 */
public abstract class DormSwipeLayoutAdapter<Object> extends ArrayAdapter
{
     ...
     * @param objects
     */
    public DormSwipeLayoutAdapter(Context context, int contentViewResourceId, int actionViewResourceId, ArrayList<HzDormMember> objects)
    {
     ...
     * @param objects
     */
    public DormSwipeLayoutAdapter(Context context, int contentViewResourceId, int actionViewResourceId, List<String> objects)
    {
        super(context,R.layout.item_swipe,objects);
        _contentViewResourceId = contentViewResourceId;
        _actionViewResourceId = actionViewResourceId;
